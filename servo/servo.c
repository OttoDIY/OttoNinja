...
void servo_attach(servo_t* servo) {
  // Configure LEDC for PWM generation
  ...
  ledc_config_channel(servo->channel, &ledc_config);
}
...
// Example angle to duty ratio function (adjust based on your servo)
