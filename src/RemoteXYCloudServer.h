#ifndef REMOTEXY_CLOUD_SERVER_H
#define REMOTEXY_CLOUD_SERVER_H
...
class CRemoteXYCloudServer : public CRemoteXYReceivePackageListener, public CRemoteXYSendPackageListener {
public:
