...
//IMPORT FROM PROJECT
#include <EEPROM.h>
//BUILT-IN; https://www.arduino.cc/en/Reference/EEPROM

#define N_SERVOS 4
//-- Primer paso: Configurar los pines en los que estan conectados los servos
/*
				 --------------- 
				|     O   O     |
				|---------------|
...
// Activar para tomar datos de calibracion de la memoria interna (?)
...
void loop()
{
	...
	dance();
	//Reiniciar la posicion de los servos
	for(int i=0;i<4;i++) servo[i].SetPosition(90);
...
void moveNServos(int time, int  newPosition[]){
	...
	iteration = 1; 
	while(millis() < final_time){ //Javi del futuro cambia esto  //Javi se olvido de cambiarlo lol
